...
class InitRegister extends StatefulWidget {
  const InitRegister({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("初期登録", style: TextStyle(color: Colors.black))),
      body: Center(
        child: SizedBox(
          ...
          child: Column(
            children: <Widget>[
              const Padding(
                ...
                child: Text("ジョブカンログイン情報登録", style: TextStyle(fontSize: 25)),
              ),
              const Padding(
              ...
              const Padding(
                padding: EdgeInsets.only(top: 8.0),
                child: Text("パスワード ", textAlign: TextAlign.left, style: TextStyle(fontSize: 14)),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: SizedBox(
